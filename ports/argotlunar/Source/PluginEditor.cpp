      ...
      optionsButton (0)
{
    ...
    matrix_mode_1_button->setToggleState (true, dontSendNotification);
    ...
    matrix_mode_2_button->setToggleState (true, dontSendNotification);
    ...
    matrix_mode_3_button->setToggleState (true, dontSendNotification);
    ...
    trans_toggle_button->setToggleState (true, dontSendNotification);
    ...
    gliss_toggle_button->setToggleState (true, dontSendNotification);
...
void PluginEditor::updateParametersFromPlugin()
{
    ...
    filtertype_combobox->setSelectedId(id, sendNotification);
    state = false;
    ...
    matrix_mode_1_button->setToggleState(state, dontSendNotification);
    state = (plugin->parameters->getMatrixMode(1) == 0) ? false : true;
    matrix_mode_2_button->setToggleState(state, dontSendNotification);
    state = (plugin->parameters->getMatrixMode(2) == 0) ? false : true;
    matrix_mode_3_button->setToggleState(state, dontSendNotification);

    // trans toggle
    state = (plugin->getParameter(kTransToggle) == 0.0f)? false : true;
    trans_toggle_button->setToggleState(state, dontSendNotification);
    updateTransSliders(state);

    // gliss toggle
    state = (plugin->getParameter(kGlissToggle) == 0.0f)? false : true;
    gliss_toggle_button->setToggleState(state, dontSendNotification);
    updateGlissSliders(state);

    // freeze toggle
    state = (plugin->getParameter(kFreezeToggle) == 0.0f)? false : true;
    freeze_toggle_button->setToggleState(state, dontSendNotification);
